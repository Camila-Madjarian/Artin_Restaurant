<?php 
	...
	if (isset($_POST['save'])) {
		...
		if (!empty($image)) {
			if ($image_size > 2000000) {
				...
				$success_msg[] = 'Imagen subida exitosamente!';
			}
		}
	}
	...
	if (isset($_POST['delete_image'])) {
		...
		$success_msg[] = 'Imagen borrada exitosamente!';
	}
			...
			<div class="box-container">
				...
				<div class="form-container">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="flex-btn">
							<input type="submit" name="save" value="Guardar post" class="btn">
							<input type="submit" name="delete_post" value="Borrar post" class="btn">
						</div>
					</form>
				</div>
				<?php 
				...
				<div class="flex-btn">
					...
					<a href="add_posts.php" class="btn">Agregar productos</a>
				</div>
				<?php } ?>
			</div>
