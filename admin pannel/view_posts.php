				...
				<form action="" method="post" class="box">
					...
					<div class="content">
						...
						<div class="flex-btn">
							...
							<button type="submit" name="delete" class="btn" onclick="return confirm('delete this product');">Borrar</button>
							<a href="read_posts.php?post_id=<?= $fetch_post['id']; ?>" class="btn">Ver post</a>
						</div>
					</div>
				</form>
				<?php 
						...
						echo '
							<div class="empty">
								<p>No hay productos agregados! <br><a href="add_product.php" class="btn" style="margin-top: 1.5rem;">Agregar productos</a></p>
							</div>
						';
					}
				?>
