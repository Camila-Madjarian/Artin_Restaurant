			...
			<div class="box-container">
				...
				<form action="" method="post" class="box">
					...
					<div class="flex-btn">
						...
						<button type="submit" name="delete" class="btn" onclick="return confirm('Borrar producto');">Borrar</button>
						<a href="view_posts.php?post_id=<?= $fetch_post['id']; ?>" class="btn">Volver</a>
					</div>
				</form>
				<?php 
						}
