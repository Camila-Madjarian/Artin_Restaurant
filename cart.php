...
<body>
	...
	<div class="banner">
        <div class="detail">
            ...
            <span><a href="home.html">Home</a><i class='bx bx-right-arrow-alt'></i>Carrito</span>
        </div>
    </div>
			...
			<form action="" method="post" class="box <?php if($fetch_products['stock'] == 0){echo 'disabled';}; ?>">
				...
				<div class="content">
					...
					<div class="flex-btn">
						...
						<button type="submit" name="delete_item" class="btn" onclick="return confirm('delete this item');">Borrar</button>
					</div>
				</div>
			</form>
			<?php 
		...
		<div class="cart-total">
			...
			<div class="button">
				<form action="" method="post">
					<button type="submit" name="empty_cart" class="btn" onclick="return confirm('¿Seguro querés vaciar tu carrito?');">Vaciar carrito</button>
				</form>
